...
mongoose.connect("mongodb://localhost:27017/TSF_BANK_DB", {
...
const defaultUserNames = ["Tamanna", "Ankita", "Vihaan", "Varun","Kirti", "Rahul", "Nitin", "Nitya", "Aakash", "Ronik"];
const defaultUsersEmail = ["tamanna@gmail.com", "ankita@gmail.com", "vihaan@gmail.com", "varun@gmail.com", "kirti@gmail.com", "Rahul@gmail.com", "nitin@gmail.com", "nitya@gmail.com", "akkii@gmail.com", "ronkik@gmail.com"];
const defaultUsersAddress = ["Faridabad, Haryana", "Bangalore, Karnataka", "Gurugram, Haryana", "Shimla, Himachal Pradesh", "Hederabad, Telangana", "Anand Vihar, New Delhi"];

const defaultUsers = [];
for (let i = 0; i < defaultUserNames.length; i++) {
    if (defaultUserNames[i] === "Tamanna" || defaultUserNames[i] === "Ankita" || defaultUserNames[i] === "Kirti" || defaultUserNames[i] === "Nitya") {
    ...
    User.find({}, function (err, foundUsers) {
        if (err) {
            ...
            if (foundUsers.length === 0) {
                ...
                res.render("index",{usersNames:users});
            }
        }
    });
